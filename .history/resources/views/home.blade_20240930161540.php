...
<body id="top">
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1>
                    "From the best development team designing <br>
                    A system built for expansion, <br>
                    An innovative room management system for the Faculty <br>
                    Crafted by the hands of Engineering students"
                </h1>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <p>
                    "RoomTech is a platform designed to simplify the process for students and faculty in efficiently finding and reserving available classrooms. Specifically tailored for arranging replacement classes, the platform makes the rescheduling process easier and more organized. With RoomTech, users can quickly check room availability, choose a room that fits set schedule, and make reservations directly through a user-friendly interface. This solution is designed to increase flexibility and convenience in classroom management within academic environments."
