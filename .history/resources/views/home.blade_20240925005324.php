...
<body id="top">
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h3>Selamat Datang di RoomTech </h3>

                <h1>
                    Kami adalah tim berdedikasi <br>
                    yang berkomitmen untuk mempermudah <br>
                    reservasi ruangan demi pengalaman <br>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead subhead--dark">Hello Mahasiswa</h3>
                <h1 class="display-1 display-1--light">Butuh ruang kelas pengganti?</h1>
            </div>
        ...
        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <p>
                    RoomTech adalah platform yang dirancang untuk memudahkan mahasiswa dan dosen dalam mencari dan memesan ruangan kelas kosong secara efisien. Aplikasi ini ditujukan khusus untuk kebutuhan pengadaan kelas pengganti mata kuliah, sehingga proses penjadwalan ulang kelas menjadi lebih mudah dan terorganisir. Dengan RoomTech, pengguna dapat dengan cepat memeriksa ketersediaan ruang, memilih ruangan yang sesuai dengan jadwal, serta melakukan reservasi secara langsung melalui antarmuka yang user-friendly. Solusi ini dihadirkan untuk meningkatkan fleksibilitas dan kenyamanan dalam manajemen kelas di lingkungan akademik.
